...
import com.atayun.hgs.wuliu.utils.sql.CarInfoSQL;
...
public class CarInfoDaoImpl implements CarInfoDao {
	...
	public ArrayList<CarInfo> getAllCarInfo(String band) {

		ArrayList<CarInfo> arrayList = null;
		arrayList = (ArrayList<CarInfo>) jdbcTemplate.query(
				CarInfoSQL.getAllCarInfoSQL, new Object[] {band},
				new int[] {java.sql.Types.VARCHAR}, new CarInfoRowMapper());
		return arrayList;
	}
